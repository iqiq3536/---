    ...
    <div class="container">
        <form id="uploadForm" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="file" id="py" name="fileUpload" accept=".py">
                <br>
            </div>
            <button type="submit" class="submit-btn" formaction="pythonServlet" id="submitBtn">测试</button>
        </form>
    </div>
</body>
</html>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var fileInput = document.getElementById('py');
